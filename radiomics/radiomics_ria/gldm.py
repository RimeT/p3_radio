...
class RadiomicsGLDM(base.RadiomicsFeaturesBase):
  ...
  .. note::
    ...
    first order - Uniformity (see :py:func:`~radiomics_ria.firstorder.RadiomicsFirstOrder.getUniformityFeatureValue()`). For
    mathematical proofs, see :ref:`here <radiomics_ria-excluded-gldm-label>`.
  ...
  def getGrayLevelNonUniformityNormalizedFeatureValue(self):
    ...
    **DEPRECATED. Gray Level Non-Uniformity Normalized (GLNN)**
    ...
    .. warning::
      ...
      :py:func:`~radiomics_ria.firstorder.RadiomicsFirstOrder.getUniformityFeatureValue()`.
      See :ref:`here <radiomics_ria-excluded-gldm-glnn-label>` for the proof. **Enabling this feature will result in the
  ...
  def getDependencePercentageFeatureValue(self):
    ...
    **DEPRECATED. Dependence Percentage**
    ...
    .. warning::
      ...
      :ref:`here <radiomics_ria-excluded-gldm-dependence-percentage-label>` for more details. **Enabling this feature will
